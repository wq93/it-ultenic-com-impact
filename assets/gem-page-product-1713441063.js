...
(function( jQuery ){
  var $module = jQuery('#m-1718255604823').children('.module');
  $module.gfV3Product();
...
(function(jQuery) {
    var $module = jQuery('#m-1718255604894').children('.module');
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1744356705304').children('.module');
  $module.gfV3ProductDesc();
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
  var $module = jQuery('#m-1743129545679').children('.module');
  ...
  $module.gfV3ProductSwatches({
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1753260727971').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function( jQuery ){
  var $module = jQuery('#m-1718255604872').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
    
(function(jQuery) {
  var $module = jQuery('#m-1718255604895').children('.module');
...
(function(jQuery) {
var $module = jQuery('#m-1718255604898').children('.module');
...
switch(style) {
  case 'slider':
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1744358231671').children('.module');
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  ...
  if(mode == 'dev') {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1744358728675').children('.module');
  if(jQuery().gfYoutube) {
    $module.gfYoutube();
  }
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  var $module = jQuery('#m-1717033901363').children('.module');
  var activeTab = parseInt($module.attr('data-activeTab')) - 1;
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  if(mode == 'dev') {
    var moduleId = "1717033901363";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1717033901363") {
      window.getTab1717033901363 = function() {
        return $module.data('gfv3restabs');
      }
    }
  }
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1716871094059').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1745893944066').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
...
(function(jQuery) {
  var $module = jQuery('#m-1745893944064').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
(function( jQuery ){
  var $module = jQuery('#m-1745893944113').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
    
    
(function(jQuery) {
  var $module = jQuery('#m-1745893944037').children('.module');
  var effect = $module.attr('data-effect');
  var magnify = $module.attr('data-zoom-level');
  var displayType = $module.attr('data-displaytype');
  $module.gfV3ProductImage({
...
(function(jQuery) {
    var $module = jQuery('#m-1745893944131').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1745893944053').children('.module');
...
(function(jQuery) {
  var $module = jQuery('#m-1745893944105').children('.module');
  var effect = $module.attr('data-effect');
  var magnify = $module.attr('data-zoom-level');
  var displayType = $module.attr('data-displaytype');
  $module.gfV3ProductImage({
...
(function(jQuery) {
    var $module = jQuery('#m-1745893944124').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
...
(function( jQuery ){
  var $module = jQuery('#m-1745893944120').children('.module');
  var style = $module.attr('data-style');
...
(function( jQuery ){
  var $module = jQuery('#m-1745893944127').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
    
(function(jQuery) {
  var $module = jQuery('#m-1745893944100').children('.module');
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  $module.gfV3ProductVariants({
    ...
    window.__gfFlowActions = []; window.__gfFlowActions.push([{"source":{"id":"#r-1745893944094"},"events":[{"key":"scrolling-to-percentage","data":{"condition":"lt","percentage":"30","runtime":"infinite"}}],"targets":[{"id":"#r-1745893944094","actions":[{"key":"hide","type":2,"data":{"delay":0,"duration":"50"}}]}]},{"source":{"id":"#r-1745893944094"},"events":[{"key":"scrolling-to-percentage","data":{"condition":"gte","percentage":"30","runtime":"infinite"}}],"targets":[{"id":"#r-1745893944094","actions":[{"key":"show","type":2,"data":{"delay":0,"duration":"50"}}]}]}]); window.__gfV1FlowActions.init();