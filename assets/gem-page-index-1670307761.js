    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1710487088061').children('.module');   
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1733458284363').children('.module');
  $module.gfV2HeroBanner({});
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1710487271409').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1733458002808').children('.module');
  $module.gfV2HeroBanner({});
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1670494169977').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
...
(function( jQuery ){
  var $module = jQuery('#m-1701313886733').children('.module');

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'production') { 
    $module.children('form').on('submit', function() {
      try {
        localStorage.setItem('gemId', '#m-1701313886733');
      } catch(err) {}
    });
