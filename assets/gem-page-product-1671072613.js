...
(function( jQuery ){
  ...
  $module.gfV3Product();
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1718162951974').children('.module');
  ...
  $module.on("click",function(){
   ...
   function copyUrl(url){
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1685592942937').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
  
    
    (function(jQuery) {
    var $module = jQuery('#m-1685592867709').children('.module');
...
(function( jQuery ){
  ...
  try {
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1671074608700').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
...
(function( jQuery ){
  ...
  $module.gfV3Product();
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1685431088972').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
  var $module = jQuery('#m-1685431088972-0').children('.module');
  var effect = $module.attr('data-effect');
  var magnify = $module.attr('data-zoom-level');
  var displayType = $module.attr('data-displaytype');
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
    var $module = jQuery('#m-1685431088972-2').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1685431088972-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  var $module = jQuery('#m-1685431102898').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
  var $module = jQuery('#m-1685431102898-0').children('.module');
  var effect = $module.attr('data-effect');
  var magnify = $module.attr('data-zoom-level');
  var displayType = $module.attr('data-displaytype');
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
    var $module = jQuery('#m-1685431102898-2').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1685431102898-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
