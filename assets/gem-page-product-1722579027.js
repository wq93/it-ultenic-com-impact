...
(function(jQuery) {
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1750239767133').children('.module');
...
switch(style) {
  case 'slider':
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1722994001992').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1722994001992";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1722994001992") {
      window.getTab1722994001992 = function() {
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1722823879564').children('.module');   
    var navspeed = $module.data('navspeed'),
...
(function( jQuery ){
  ...
  if(mode == 'dev') {
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1722829863537').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1722830499752').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
...
(function( jQuery ){
  var $module = jQuery('#m-1722996538290').children('.module');
  var activeTab = parseInt($module.attr('data-activeTab')) - 1;
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  if(mode == 'dev') {
    var moduleId = "1722996538290";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1722996538290") {
      window.getTab1722996538290 = function() {
        return $module.data('gfv3restabs');
      }
    }
  }
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1722996467532').children('.module');
